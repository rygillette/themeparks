...
const SixFlagsDarienLake = require('./sixflags/sixflagsdarienlake');
const SixFlagsHurricaneHarborChicago = require('./sixflags/sixflagshurricaneharborchicago');
const SixFlagsFrontierCity = require('./sixflags/sixflagsfrontiercity');
const SixFlagsHurricaneHarborOklahomaCity = require('./sixflags/sixflagshurricaneharboroklahomacity');
const SixFlagsHurricaneHarborPhoenix = require('./sixflags/sixflagshurricaneharborphoenix');
const SixFlagsHurricaneHarborSplashtown = require('./sixflags/sixflagshurricaneharborsplashtown');
const SixFlagsHurricaneHarborRockford = require('./sixflags/sixflagshurricaneharborrockford');
// PortAventura
...
exports.AllParks = [
  ...
  SixFlagsDarienLake,
  SixFlagsHurricaneHarborChicago,
  SixFlagsFrontierCity,
  SixFlagsHurricaneHarborOklahomaCity,
  SixFlagsHurricaneHarborPhoenix,
  SixFlagsHurricaneHarborSplashtown,
  SixFlagsHurricaneHarborRockford,
  // PortAventura
  PortAventura,
  FerrariLand,
  // Merlin Parks
